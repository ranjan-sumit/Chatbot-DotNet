...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class RootDialog : IDialog<object>
    {
        ...
        {
            /* When MessageReceivedAsync is called, it passed an IAwaitable<IMessageActivity>. To get the message,
                *  await the result. */
    ...
    public class BasicQnAMakerPreviewDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerPreviewDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.GetSetting("QnAAuthKey"), ConfigurationManager.AppSettings["QnAKnowledgebaseId"], "I am Sorry, I cannot help you at this moment. Please try again after sometime or call to customer care at 18008080", 0.5)))
        { }
    }
